...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_background_container prlx_parent">
            <div class="home_background prlx" style="background-image: url('{{ asset('images/teachers_background.jpg') }}')"></div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 teacher">
                    <div class="card">
                        <div class="card_img">
                            ...
                            <img class="card-img-top trans_200" src="{{ asset('images/teacher_1.jpg') }}" alt="https://unsplash.com/@michaeldam">
                        </div>
                ...
                <div class="col-lg-4 teacher">
                    <div class="card">
                        <div class="card_img">
                            <div class="card_plus trans_200 text-center"><a href="#">+</a></div>
                            <img class="card-img-top trans_200" src="{{ asset('images/teacher_2.jpg') }}" alt="https://unsplash.com/@jcpeacock">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col-lg-4 teacher">
                    <div class="card">
                        <div class="card_img">
                            <div class="card_plus trans_200 text-center"><a href="#">+</a></div>
                            <img class="card-img-top trans_200" src="{{ asset('images/teacher_3.jpg') }}" alt="https://unsplash.com/photos/n8jeOSxCRfQ">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col-lg-4 teacher">
                    <div class="card">
                        <div class="card_img">
                            <div class="card_plus trans_200 text-center"><a href="#">+</a></div>
                            <img class="card-img-top trans_200" src="{{ asset('images/teacher_4.jpg') }}" alt="https://unsplash.com/@seteales">
                        </div>
                        <div class="card-body text-center">
                ...
                <div class="col-lg-4 teacher">
                    <div class="card">
                        <div class="card_img">
                            <div class="card_plus trans_200 text-center"><a href="#">+</a></div>
                            <img class="card-img-top trans_200" src="{{ asset('images/teacher_5.jpg') }}" alt="https://unsplash.com/@jaredsluyter">
                        </div>
                        <div class="card-body text-center">
                            <div class="card-title"><a href="#">Julie Denver</a></div>
                            <div class="card-text">Graphic Designer</div>
                ...
                <div class="col-lg-4 teacher">
                    <div class="card">
                        <div class="card_img">
                            <div class="card_plus trans_200 text-center"><a href="#">+</a></div>
                            <img class="card-img-top trans_200" src="{{ asset('images/teacher_6.jpg') }}" alt="https://unsplash.com/@mehdizadeh">
                        </div>
                        <div class="card-body text-center">
                            <div class="card-title"><a href="#">Julie Denver</a></div>
                            <div class="card-text">Graphic Designer</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 milestone_col">
                    <div class="milestone text-center">
                        <div class="milestone_icon">
                            <img src="{{ asset('images/milestone_1.svg') }}" alt="https://www.flaticon.com/authors/zlatko-najdenovski">
                        </div>
                ...
                <div class="col-lg-3 milestone_col">
                    <div class="milestone text-center">
                        <div class="milestone_icon">
                            <img src="{{ asset('images/milestone_2.svg') }}" alt="https://www.flaticon.com/authors/zlatko-najdenovski">
                        </div>
                ...
                <div class="col-lg-3 milestone_col">
                    <div class="milestone text-center">
                        <div class="milestone_icon">
                            <img src="{{ asset('images/milestone_3.svg') }}" alt="https://www.flaticon.com/authors/zlatko-najdenovski">
                        </div>
                ...
                <div class="col-lg-3 milestone_col">
                    <div class="milestone text-center">
                        <div class="milestone_icon">
                            <img src="{{ asset('images/milestone_4.svg') }}" alt="https://www.flaticon.com/authors/zlatko-najdenovski">
                        </div>
            ...
            <div class="row row-eq-height">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="become_image">
                        <img src="{{ asset('images/become.jpg') }}" alt="Educhains Instructor">
                    </div>
                </div>
